...
client = MongoClient('mongodb+srv://fibin:fibin404@cluster0.u9gx0jy.mongodb.net/')
db_flight = client['flight']
collection_routes = db_flight['newRoutes']
collection_airports = db_flight['Airports']

# Initialize MongoDB connection for the second collection
...
# Create a request model to define the structure of the POST request data
class RouteRequest(BaseModel):
    fromiata: str
    toiata: str
    daynumber: int

# Create a request model to accept a list of RouteRequest objects
